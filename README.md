...
orientation="ZZ"  #set which type of strain, you should set mystrain blank!!!
initial=0.00       #set the initial strain
step=0.01         #set the step size
num=40             #how much strain to apply
mpiexec="mpirun -np $JH_NCPU -machinefile $JH_HOSTFILE vasp_ncl  >> vasp.log" 
...
do
    ...
    if [ -n "$conver" ]; then
        ...
        echo "Failure warning: present iretation not converge, you may adjust your INCAR!"
        break
    fi
done
